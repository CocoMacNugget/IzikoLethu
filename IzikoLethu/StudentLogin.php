...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['full_name'], $_POST['email'], $_POST['student_number'], $_POST['password'])) {
...
<body>
    ...
    <div class="card container vh-50 d-flex justify-content-center align-items-center" style="width: 700px;">
        <form method="POST">
            ...
            <div class="mb-3">
                <input type="text" class="form-control" name="student_number" placeholder="Student Number" required>
            </div>
